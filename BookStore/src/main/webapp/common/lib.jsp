...
<!-- Product view slider -->
<link rel="stylesheet" type="text/css" href="<c:url value="/template/web/css/jquery.simpleLens.css" />">
<!-- slick slider -->
<link rel="stylesheet" type="text/css" href="<c:url value="/template/web/css/slick.css" />">
<!-- price picker slider -->
<link rel="stylesheet" type="text/css" href="<c:url value="/template/web/css/nouislider.css" />">
<!-- Theme color -->
...
<script type="text/javascript" src="<c:url value="/template/web/js/jquery.smartmenus.js" />"></script>
<!-- SmartMenus jQuery Bootstrap Addon -->
<script type="text/javascript" src="<c:url value="/template/web/js/jquery.smartmenus.bootstrap.js" />"></script>
<!-- To Slider JS -->
